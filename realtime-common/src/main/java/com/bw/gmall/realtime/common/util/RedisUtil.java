...
public class RedisUtil {
    ...
    public static void writeDim(Jedis jedis, String tableName, String id, JSONObject dim) {
        ...
        jedis.setex(getKey(tableName, id), Integer.parseInt(Constant.TWO_DAY_SECONDS), dim.toJSONString());
    }
    ...
    public static void writeDimAsync(StatefulRedisConnection<String, String> redisAsyncConn,
        ...
        asyncCommand.setex(key, Long.parseLong(Constant.TWO_DAY_SECONDS), dim.toJSONString());
